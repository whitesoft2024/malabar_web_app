...
const BranchTransfer = () => {
    ...
    const handleRequestSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://api.malabarbank.in/api/transfer-requests/breq', requestData);
    ...
    //fetch requests made by the branch side to admin side
    ...
    const handlePaymentSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://api.malabarbank.in/api/transfer-money/btra', allData);
            console.log(response.data);
            alert(response.data.message);
            // Optionally, close the modal and reset form state
            handleCloseModal();
    ...
    const fetchTransfers = async () => {
        try {
            const response = await fetch('https://api.malabarbank.in/api/transfer-money/btra')
            const data = await response.json()
                ...
                <div>
                    <center>
                        <div>
                            ...
                            <label htmlFor="send">Request to Admin</label>
                    ...
                    <div>
                        ...
                        <center>
                            <Table striped bordered hover>
                                ...
                                <tbody>
                                    {parsedData
                                        .filter(request => request.fromBranch === loginBranch)
                                        .reverse()
                                        .map((request, index) => (
                                            <tr key={request._id}>
                                                <td>{index + 1}</td>
                    ...
                    <div>
                        ...
                        <center>
                            <Table striped bordered hover>
                                ...
                                <tbody>
                                    {sendData
                                        .filter(request => request.toBranch === loginBranch)
                                        .map((request, index) => (
                                            <tr key={request._id}>
                                                <td>{index + 1}</td>
                                                <td>{request.date}</td>
                                ...
                                <form onSubmit={handleRequestSubmit} className=" mt-3">
                                    <div className="form-group d-flex flex-row">
                                        ...
                                        <div className="col">
                                            ...
                                            <input type="text" className="form-control" id="toBranch" name="toBranch" value={requestData.toBranch || ""} onChange={handleChangeRequest} placeholder="Head Office" required readOnly/>
                                        </div>
                                    </div>
                                    <div className="form-group d-flex flex-row">
                                        <div className="col">
                            ...
                            <div className="card-body ">
                                <form onSubmit={handleTransferSubmit} className=" mt-3">
                                    <div className="form-group d-flex flex-row">
                                        ...
                                        <div className="col">
                                            <label className="labels" htmlFor="toBranch">To Branch :</label>
                                            <input type="text" className="form-control" id="toBranch" name="toBranch" value={transferData.toBranch || ""} onChange={handleChangeTransfer} placeholder="Head Office" required readOnly />
                                        </div>
                                    </div>
                                    <div className="form-group d-flex flex-row">
                                        <div className="col">
                                                                        ...
                                                                        <div className="col-12">
                                                                            <div className="form-card">
                                                                                ...
                                                                                <form onsubmit="event.preventDefault()">
                                                                                    <div className="row">
                                                                                        <div className="col-12">
                                                                                            <div className="input-group"> <input type="text" id="cashTransactionId" name="cashTransactionId" placeholder="" minLength="16" maxLength="16" value={cashTransactionId}
                                                                                                onChange={(e) => setcashTransactionId(e.target.value)} required/>
                                                                                    ...
                                                                                    <div className="row">
                                                                                        <div className="col-12">
                                                                                            <div className="input-group"> <input type="text" id="amount" name="amount" value={tempTransferData.amount || ""} onChange={handleChangeTransfer} placeholder="" required/> <label>AMOUNT </label> </div>
                                                                                        </div>
                                                                                        <div className="col-12">
                                                                                            <div className="input-group"> <input type="text" id="amountWord" name="amountWord" value={tempTransferData.amountWord || ""} onChange={handleChangeTransfer} placeholder="" /> <label>AMOUNT IN WORDS</label> </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                        ...
                                                                        <div className="col-12">
                                                                            <div className="form-card">
                                                                                ...
                                                                                <form onsubmit="event.preventDefault()">
                                                                                    ...
                                                                                    <div className="row">
                                                                                        <div className="col-12">
                                                                                            <div className="input-group"> <input
                                                                                                ...
                                                                                                placeholder=""
                                                                                                value={tempTransferData.beneficiaryName || ""}
                                                                                    ...
                                                                                    <div className="row">
                                                                                        <div className="col-12">
                                                                                            <div className="input-group"> <input type="text" id="amount" name="amount" required placeholder="" value={tempTransferData.amount || ""} onChange={handleChangeTransfer} /> <label>AMOUNT</label> </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div className="row">
                                                                                        <div className="col-12">
                                                                                            <div className="input-group"> <input
                                                                                                ...
                                                                                                placeholder=""
                                                                                                required
                                                                                                value={tempTransferData.bankName || ""}
                                                                                                onChange={handleChangeTransfer}
                                                                                    ...
                                                                                    <div className="row">
                                                                                        <div className="col-12">
                                                                                            <div className="input-group"> <input
                                                                                                ...
                                                                                                placeholder=""
                                                                                                required
                                                                                                value={tempTransferData.accountNumber || ""}
                                                                                                onChange={handleChangeTransfer}
                                                                                    ...
                                                                                    <div className="row">
                                                                                        <div className="col-12">
                                                                                            <div className="input-group"> <input
                                                                                                ...
                                                                                                name="ifsc"
                                                                                                placeholder=""
                                                                                                value={tempTransferData.ifsc || ""}
                                                                                                onChange={handleChangeTransfer}
                                                                                            /> <label>IFSC</label> </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div className="row">
                                                                                        <div className="col-12">
