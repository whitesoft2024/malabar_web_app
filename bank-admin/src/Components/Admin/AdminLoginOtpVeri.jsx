...
const AdminLoginOtpVeri = ({ isOpen, onRequestClose, loginData }) => {
  ...
  try {
    ...
    const response = await axios.post('http://localhost:2000/verify-admin-otp', updatedSignUpData);
...
export default AdminLoginOtpVeri;
