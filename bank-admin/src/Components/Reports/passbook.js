...
function Passbook() {
  ...
  const generateRows = () => {
    ...
    DatefilteredTransactions.forEach(transaction => {
      if (transaction.date || transaction.newDate) {
        const entryDate = parseDate(transaction.date || transaction.newDate).getTime();
    ...
    const transactionRows = DatefilteredTransactions.flatMap((transaction) => {
      const entryDate = transaction.date || transaction.Date || transaction.newDate;
  ...
  <div class="front-page-details">
      ...
      <p class="spacer">.</p>
      <p class="spacer">.</p>
    <h2>THE MALABAR MULTI STATE AGRO</h2>
    <p>CO-OPERATIVE SOCIETY LIMITED</p>
    <div class="container">
      <div class="column">
        ...
        <div class="row">
          ...
          <span class="value">${formData.accountNumber || 'N/A'}</span>
        </div>
      </div>
      <div class="column">
        <div class="row">
