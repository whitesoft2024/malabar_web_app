...
function DailyReportEmployee() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const response = await axios.get(`http://localhost:2000/api/RDSdata?date=${formattedDate}&branch=${branchCode}`);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const branchCode = user.branchDetails?.branchCode;
        const response = await axios.get(`http://localhost:2000/api/fd?date=${formattedDate}&branchCode=${branchCode}`);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const branchCode = user.branchDetails?.branchCode;
        const response = await axios.get(`http://localhost:2000/api/savings?date=${formattedDate}&branchCode=${branchCode}`);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const branchCode = user.branchDetails?.branchCode;
        const response = await axios.get(`http://localhost:2000/api/membership?date=${formattedDate}&branchCode=${branchCode}`);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const branchCode = user.branchDetails?.branchCode;
        const response = await axios.get(`http://localhost:2000/api/expense-book/Expense?date=${formattedDate}&branchCode=${branchCode}`);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const branchCode = user.branchDetails?.branchCode;
        const response = await axios.get(`http://localhost:2000/api/receipt-ledger/receiptLedger?date=${formattedDate}&branchCode=${branchCode}`);
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const branchCode = user.branchDetails?.branchCode;
        const response = await axios.get(`http://localhost:2000/api/payment-ledger/payLedger?date=${formattedDate}&branchCode=${branchCode}`);
    ...
    async function fetchData() {
      try {
        const response = await axios.get(
          `http://localhost:2000/api/rd?date=${selectedDate}`
        );
