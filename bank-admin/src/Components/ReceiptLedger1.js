...
function ReceiptLedger() {
  ...
  const expenditureCategories = [
    { value: "On description", label: "On description" }
  ...
  const generateVoucherNumber = async () => {
    ...
    newVoucherNumber = `R${'0'.repeat(7 - number.toString().length)}${number}`;

    // Check if the voucher number already exists in the database
    try {
      const response = await axios.get(`https://api.malabarbank.in/api/receipt-ledger/recled/check-voucher-number/${newVoucherNumber}`);
  ...
  const handleExpenseSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://api.malabarbank.in/api/receipt-ledger/recled', updatedExpenseData);
            ...
            <div className="card mt-0">
              ...
              <div className="card-body ">
                <form onSubmit={handleExpenseSubmit} className=" mt-3">
                  ...
                  <div className="form-group d-flex flex-row">
                    <div className="col">
                      <label className="labels" htmlFor="category">Receipt Category :</label>
                  ...
                  <div className="form-group d-flex flex-row">
                    ...
                    <div className="col">
                      <label className="labels" htmlFor="voucherNumber">Reciept Number :</label>
