...
const handleSearch = (e) => {
    ...
    setSearchTerm(value);
    // Call a function to fetch data based on the search term
    fetchMemberships(1, pageSize, branchCode, value); // Include search term
};
...
const handlePageSizeChange = (e) => {
    ...
    const fetchReceiptData = (mobile) => {
        ...
        if (selectedCustomer) {
            setReceiptData(selectedCustomer);
        } else {
            setReceiptData(null);
        }
    };
